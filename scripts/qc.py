...
def run_qc_checks(data, expected_channels, min_events_threshold=10000):
    actual_channels = list(data.columns)
    event_count = data.shape[0]
    event_count_ok = event_count >= min_events_threshold
    ...
    overall_pass = event_count_ok and channels_ok and no_constant_channels
...
if __name__ == "__main__":
    ...
    qc_results = run_qc_checks(data, expected_channels)
    qc_results["sample"] = sample_name
